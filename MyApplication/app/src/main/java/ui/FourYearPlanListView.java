...
public class FourYearPlanListView extends ExpandableListView {

	private static final String TAG = "FourYearPlanListView";
	...
	private FourYearPlanAdapter adapter;
	private FourYearPlanListeners listeners;
	private int dragOffset = 50;
	private boolean dragOnLongPress;
	private boolean pressedItem;
	private Handler handler = new Handler();

	public FourYearPlanListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	/*@Override
	public void setAdapter(FourYearPlanAdapter adapter) {
		// TODO Auto-generated method stub
		super.setAdapter(adapter);
		this.adapter = (FourYearPlanAdapter) adapter;
	}*/
	 ...
	 */
	public FourYearPlanListeners getListeners() {
		return listeners;
	}
	 ...
	 */
	public void setListeners(FourYearPlanListeners listeners) {
